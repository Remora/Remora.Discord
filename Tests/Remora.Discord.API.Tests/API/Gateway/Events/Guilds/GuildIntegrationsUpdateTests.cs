//
//  GuildIntegrationsUpdateTests.cs
//
//  Author:
...
/// </summary>
public class GuildIntegrationsUpdateTests : GatewayEventTestBase<IGuildIntegrationsUpdate>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="GuildIntegrationsUpdateTests"/> class.
    /// </summary>
    /// <param name="fixture">The test fixture.</param>
    public GuildIntegrationsUpdateTests(JsonBackedTypeTestFixture fixture)
        : base(fixture)
    {
    }
