...
/// </summary>
public class GuildMemberRemoveTests : GatewayEventTestBase<IGuildMemberRemove>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="GuildMemberRemoveTests"/> class.
    /// </summary>
    /// <param name="fixture">The test fixture.</param>
    public GuildMemberRemoveTests(JsonBackedTypeTestFixture fixture)
        : base(fixture)
    {
    }
