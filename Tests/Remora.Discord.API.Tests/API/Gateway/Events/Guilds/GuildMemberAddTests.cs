...
/// </summary>
public class GuildMemberAddTests : GatewayEventTestBase<IGuildMemberAdd>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="GuildMemberAddTests"/> class.
    /// </summary>
    /// <param name="fixture">The test fixture.</param>
    public GuildMemberAddTests(JsonBackedTypeTestFixture fixture)
        : base(fixture)
    {
    }
