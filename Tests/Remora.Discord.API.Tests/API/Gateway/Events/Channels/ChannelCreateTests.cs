...
/// <summary>
/// Tests the ChannelCreate event.
/// </summary>
public class ChannelCreateTests : GatewayEventTestBase<IChannelCreate>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="ChannelCreateTests"/> class.
    /// </summary>
    /// <param name="fixture">The test fixture.</param>
    public ChannelCreateTests(JsonBackedTypeTestFixture fixture)
        : base(fixture)
    {
    }
