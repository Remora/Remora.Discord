...
/// <summary>
/// Tests the ThreadUpdate event.
/// </summary>
public class ThreadUpdateTests : GatewayEventTestBase<IThreadUpdate>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="ThreadUpdateTests"/> class.
    /// </summary>
    /// <param name="fixture">The test fixture.</param>
    public ThreadUpdateTests(JsonBackedTypeTestFixture fixture)
        : base(fixture)
    {
    }
