...
/// <summary>
/// Tests the <see cref="LazyTokenStore"/> class.
/// </summary>
public class LazyTokenStoreTests
{
    /// <summary>
    ...
    public class Token
    {
        ...
        {
            var tokenStore = new LazyTokenStore(() => new("Hello world!"), DiscordTokenType.Bearer);
    ...
    public class TokenType
    {
        ...
        {
            var tokenStore = new LazyTokenStore(() => new("Hello world!"), DiscordTokenType.Bot);
