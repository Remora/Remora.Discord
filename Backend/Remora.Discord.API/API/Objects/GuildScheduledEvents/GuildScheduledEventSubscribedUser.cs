//
//  GuildScheduledEventSubscribedUser.cs
//
//  Author:
...
/// <inheritdoc cref="IGuildScheduledEventSubscribedUser"/>
public record GuildScheduledEventSubscribedUser
(
    Snowflake ID,
    string Username,
...
(
    ...
    PremiumType,
    PublicFlags
), IGuildScheduledEventSubscribedUser;
