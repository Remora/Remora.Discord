...
/// <inheritdoc cref="Remora.Discord.API.Abstractions.Gateway.Events.IAutoModerationRuleUpdate" />
[PublicAPI]
public record AutoModerationRuleUpdate
(
    Snowflake ID,
    Snowflake GuildID,
    string Name,
