...
/// <inheritdoc cref="Remora.Discord.API.Abstractions.Gateway.Events.IAutoModerationRuleDelete" />
[PublicAPI]
public record AutoModerationRuleDelete
(
    Snowflake ID,
    Snowflake GuildID,
    string Name,
