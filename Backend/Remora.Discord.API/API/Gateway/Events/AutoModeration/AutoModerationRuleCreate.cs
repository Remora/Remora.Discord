...
/// <inheritdoc cref="Remora.Discord.API.Abstractions.Gateway.Events.IAutoModerationRuleCreate" />
[PublicAPI]
public record AutoModerationRuleCreate
(
    Snowflake ID,
    Snowflake GuildID,
    string Name,
