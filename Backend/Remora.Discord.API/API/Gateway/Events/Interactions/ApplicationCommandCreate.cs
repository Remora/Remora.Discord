...
{
    /// <inheritdoc cref="Remora.Discord.API.Abstractions.Gateway.Events.IApplicationCommandCreate" />
    public record ApplicationCommandCreate
    (
        Snowflake ID,
