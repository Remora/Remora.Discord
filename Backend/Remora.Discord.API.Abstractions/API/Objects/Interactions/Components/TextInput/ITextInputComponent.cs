...
/// </remarks>
public interface ITextInputComponent : IPartialTextInputComponent, IMessageComponent
{
    ...
    /// <inheritdoc/>
    Optional<TextInputStyle> IPartialTextInputComponent.Style => Style;

    /// <inheritdoc/>
    Optional<string> IPartialTextInputComponent.Label => Label;
}
