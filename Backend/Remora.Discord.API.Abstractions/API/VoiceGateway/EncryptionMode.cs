...
namespace Remora.Discord.API.Abstractions.API.VoiceGateway
{
    /// <summary>
    /// Enumerates the encryption modes that the voice connection supports.
    /// More specifically, specifies how nonces should be used within the encryption algorithm,
    /// and attached to RTP packets for communication with Discord.
    /// </summary>
    [PublicAPI]
