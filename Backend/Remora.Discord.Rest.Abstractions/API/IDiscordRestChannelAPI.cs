...
using Remora.Discord.Rest.Abstractions.Invites;
using Remora.Discord.Rest.Abstractions.Messages;
...
namespace Remora.Discord.Rest.Abstractions
{
    ...
    public interface IDiscordRestChannelAPI
    {
        ...
        /// <param name="ct">The cancellation token for this operation.</param>
        /// <returns>A retrieval result which may or may not have succeeded.</returns>
        Task<IDeleteRestEntityResult> DeleteChannelAsync(Snowflake channelID, CancellationToken ct);
        ...
        /// <param name="channelID">The ID of the channel.</param>
        /// <param name="around">
        /// The ID of the message to get messages around. This is a mutually exclusive option with <see cref="before"/>
        /// and <see cref="after"/>.
        /// </param>
        /// <param name="before">
        /// The ID of the message to get messages before. This is a mutually exclusive option with <see cref="around"/>
        /// and <see cref="after"/>.
        /// </param>
        /// <param name="after">
        /// The ID of the message to get messages after. This is a mutually exclusive option with <see cref="before"/>
        /// and <see cref="around"/>.
        /// </param>
        ...
        /// <remarks>
        /// At least one of <see cref="content"/>, <see cref="embed"/>, or <see cref="file"/> must be present.
        /// </remarks>
        /// </summary>
        /// <param name="channelID">The ID of the channel.</param>
